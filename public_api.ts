...
export * from './src/competition/repository';
export * from './src/league';
export * from './src/league/repository';
export * from './src/config';
export * from './src/field';
export * from './src/field/repository';
...
export * from './src/round/number/config';
export * from './src/round/number/config/repository';
export * from './src/round/number/config/service';
export * from './src/round/repository';
export * from './src/round/number/repository';
export * from './src/round/number/config/score';
export * from './src/round/number/config/score/repository';
